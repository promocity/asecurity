//состо¤ни¤ нажатых чекбоксов по умолчанию
...
function calculate(clicked_element,page){	
	//ценовые значени¤ дл¤ каждой из страниц
	...
	if (default_online_control == true){
        ...
        //всЄ что ниже нужно, чтобы был пробел после тыс¤чи
        //price1_result_1000 - числитель от делени¤ на тыс¤чу стоимости услуг
        //price1_result_1    - остаток от делени¤ на тыс¤чу стоимости услуг
	if (price1_result > 999){
        ...
        //вывод резутатов стоимости обслуживани¤
        //price2_result_1000 - числитель от делени¤ на тыс¤чу стоимости обслуживани¤
        //price2_result_1    - остаток от делени¤ на тыс¤чу стоимости обслуживани¤
	if (price2_result > 999){
		...
		if (price2_result_1>=0 && price2_result_1<=9){
			price_down2.innerHTML = price2_result_1000+' 00'+price2_result_1+' Р<span>в месяц</span>';	
		}
		if(price2_result_1>0 && price2_result_1<=99){
			price_down2.innerHTML = price2_result_1000+' 0'+price2_result_1+' Р<span>в месяц</span>';	
		}
		if (price2_result_1>99){
			price_down2.innerHTML = price2_result_1000+' '+price2_result_1+' Р<span>в месяц</span>';	
		}
	}else{
		price_down2.innerHTML = price2_result+' Р<span>в месяц</span>';
	}
